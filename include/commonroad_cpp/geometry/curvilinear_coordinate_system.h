...
typedef std::shared_ptr<CurvilinearCoordinateSystem> CurvilinearCoordinateSystemPtr;
typedef std::shared_ptr<const CurvilinearCoordinateSystem> CurvilinearCoordinateSystemConstPtr;
} // namespace geometry
...
class CurvilinearCoordinateSystem : public std::enable_shared_from_this<CurvilinearCoordinateSystem> {
  public:
     ...
     */
    CurvilinearCoordinateSystem(const EigenPolyline &reference_path, double default_projection_domain_limit = 20.,
    ...
    void determineSubsetsOfMultiPolygonsWithinProjectionDomain(
        const std::vector<EigenPolyline> &polygons, const std::vector<int> groups_of_polygons,
        const int num_omp_threads, std::vector<EigenPolyline> &polygons_in_projection_domain,
    ...
    static CurvilinearCoordinateSystemConstPtr deserialize(std::istream &output_stream);
  ...
  private:
    ...
    convertToCurvilinearCoords(const std::vector<EigenPolyline> &groups_of_points, int num_omp_threads) const;
     ...
     */
    void createSegment(const Eigen::Vector2d &pt_1, const Eigen::Vector2d &pt_2, const Eigen::Vector2d &t_1,
    ...
    void interpolatePointsBetweenSegments(const Eigen::Vector2d cartesian_point,
                                          ...
                                          const std::list<int> indices_range, EigenPolyline &transformed_polygon) const;
    ...
    void rasterizeListOfTransformedPolygonsInProjectionDomain(
        const std::vector<EigenPolyline> &transformed_polygon, const std::set<int> &segment_indices,
     ...
     */
    void
    rasterizeTransformedPolygonInProjectionDomain(const EigenPolyline &transformed_polygon,
     ...
     */
    std::vector<int>
    findCandidatePointsInSegment(int segment_idx,
    ...
    void determineCurvilinearCoordinatesAndSegmentIdx(
        ...
        int num_omp_threads, std::vector<std::vector<std::tuple<int, double, double>>> &groups_of_curvil_points) const;
