 ...
 */
void initIncomingGroupContainer(IncomingGroupContainer &incomingGroupContainer, const commonroad::Intersection& intersectionMsg);

/**
 * Initializes container of oucomingGroups.
 *
 * @param outgoingGroupContainer OutcomingGroup container
 * @param intersectionMsg CommonRoad message
 */
void initOutgoingGroupContainer(OutgoingGroupContainer& outgoingGroupContainer, const commonroad::Intersection& intersectionMsg);
...
/**
 * Returns incomingGroup from container of incomingGroups.
 *
 * @param incomingGroupId IncomingGroup id
 * @param incomingGroupContainer IncomingGroup container
 * @return Pointer to IncomingGroup
 */
std::shared_ptr<IncomingGroup> getIncomingGroupFromContainer(size_t incomingGroupId,
                                                             IncomingGroupContainer &incomingGroupContainer);

/**
 * Returns outgoingGroup from container of outgoingGroups.
 *
 * @param outgoingGroupId OutgoingGroup id
 * @param outgoingGroupContainer OutgoingGroup container
 * @return Pointer to OutgoingGroup
 */
std::shared_ptr<OutgoingGroup> getOutgoingGroupFromContainer(size_t outgoingGroupId,
...
/**
 * Creates incomingGroup from protobuf message "Incoming".
 *
 ...
 * @return Incoming
 */
std::shared_ptr<IncomingGroup> createIncomingFromMessage(const commonroad_map::IncomingGroup& incomingGroupMsg, LaneletContainer& laneletContainer,
                                                         IncomingGroupContainer & incomingGroupContainer);
