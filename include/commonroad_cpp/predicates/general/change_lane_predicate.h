...
/**
 * Predicate for evaluating if a vehicle is going to change the lane
 */
class ChangeLanePredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for ChangeLanePredicate
     */
    ChangeLanePredicate();
