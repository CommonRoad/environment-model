...
/**
 * Predicate evaluates whether a vehicle has its left signal set.
 */
class LeftSignalSetPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for LeftSignalSetPredicate
     */
    LeftSignalSetPredicate();
