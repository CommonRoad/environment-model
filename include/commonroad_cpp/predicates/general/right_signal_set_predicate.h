...
/**
 * Predicate evaluates whether a vehicle has its right signal set.
 */
class RightSignalSetPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for RightSignalSetPredicate
     */
    RightSignalSetPredicate();
