...
/**
 *  Evaluates if a vehicle is at a t intersection
 */
class AtTIntersectionPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for AtTIntersectionPredicate
     */
    AtTIntersectionPredicate();
