...
/**
 *  Evaluates if a vehicle is at an uncontrolled intersection
 */
class AtUncontrolledIntersectionPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for AtUncontrolledIntersectionPredicate
     */
    AtUncontrolledIntersectionPredicate();
