...
/**
 *  Evaluates if a vehicle is in an intersection (excluding incoming lanelets).
 */
class InIntersectionPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for InIntersectionPredicate
     */
