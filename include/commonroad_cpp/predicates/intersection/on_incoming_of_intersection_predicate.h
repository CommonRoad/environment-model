...
/**
 * Evaluates if a vehicle is on an incoming belonging to a specified intersection.
 */
class OnIncomingOfIntersectionPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for OnIncomingOfIntersectionPredicate
     */
    OnIncomingOfIntersectionPredicate();
