...
/**
 * Evaluates if a vehicle drives in the correct direction
 */
class InLaneletDrivingDirPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for InLaneletDrivingDirPredicate
     */
    InLaneletDrivingDirPredicate();
