...
/**
 * Evaluates whether the pth vehicle is in the lane to the left of the kth vehicle.
 */
class InNeighboringLeftLanePredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for InNeighboringLeftLanePredicate.
     */
    InNeighboringLeftLanePredicate();
