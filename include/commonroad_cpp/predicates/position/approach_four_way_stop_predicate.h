...
/**
 *  Evaluates if a vehicle is approaching a four way stop intersection
 */
class ApproachFourWayStopPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for Approach4WayStopPredicate
     */
    ApproachFourWayStopPredicate();
