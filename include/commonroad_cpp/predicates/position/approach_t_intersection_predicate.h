...
/**
 *  Evaluates if a vehicle is approaching a t intersection
 */
class ApproachTIntersectionPredicate : public CommonRoadPredicate {
public:
    /**
      * Constructor for ApproachTIntsectionPredicate
     */
    ApproachTIntersectionPredicate();
