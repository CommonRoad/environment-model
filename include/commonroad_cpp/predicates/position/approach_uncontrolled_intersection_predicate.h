...
/**
 *  Evaluates if a vehicle is approaching an uncontrolled intersection
 */
class ApproachUncontrolledIntersectionPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for ApproachUncontrolledIntersectionPredicate
     */
    ApproachUncontrolledIntersectionPredicate();
