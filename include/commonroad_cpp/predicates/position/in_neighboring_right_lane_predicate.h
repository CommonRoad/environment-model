...
/**
 * Evaluates whether the pth vehicle is in the lane to the right of the kth vehicle.
 */
class InNeighboringRightLanePredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for InNeighboringRightLanePredicate.
     */
    InNeighboringRightLanePredicate();
