...
struct PredicateParameters {
    ...
    std::map<std::string, double> paramMap{
        ...
        {"numVehCongestion",
         3.0}, // minimum number of leading vehicles so that a vehicle can be assumed to be part of a congestion
        {"maxCongestionVelocity", 2.78}, // maximum velocity of a vehicle withing a congestion
        {"numVehSlowMovingTraffic",
         3.0}, // minimum number of leading vehicles so that a vehicle can be assumed to be part of slow-moving traffic
        {"maxSlowMovingTrafficVelocity", 8.33}, // maximum velocity of a slow-moving vehicle
        {"numVehQueueOfVehicles",
         3.0}, // minimum number of leading vehicles so that a vehicle can be assumed to be part of a queue of vehicles
