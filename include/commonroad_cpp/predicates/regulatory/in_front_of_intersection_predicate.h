...
/**
 *  Evaluates if a vehicle is before the intersection
 */
class InFrontOfIntersectionPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for InFrontOfIntersectionPredicate
     */
    InFrontOfIntersectionPredicate();
