...
/**
 * Evaluates whether two obstacles have the same priority at an intersection.
 */
class SamePriorityPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for SamePriorityPredicate.
     */
