...
struct RoadNetworkParameters {
    ...
    constexpr static const double eps1{0.1};            // param to reduce lateral distance of the projection domain border from the reference path
    ...
    constexpr static const double projectionDomainLimit{20.0};  // maximum absolute distance of the projection domain border from the reference path
    constexpr static const size_t numAdditionalSegmentsCCS{3}; // number of additional segments added at beginning to CCS
};