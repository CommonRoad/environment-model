...
std::map<std::string, std::shared_ptr<CommonRoadPredicate>> predicates{
    ...
    {"main_carriageway_right_lane", std::make_shared<LeftOfPredicate>()},
    ...
    {"keeps_fov_speed_limit", std::make_shared<KeepsBrakingSpeedLimitPredicate>()},
    {"keeps_lane_speed_limit", std::make_shared<KeepsLaneSpeedLimitPredicate>()},
    {"keeps_type_speed_limit", std::make_shared<KeepsLaneSpeedLimitPredicate>()},
