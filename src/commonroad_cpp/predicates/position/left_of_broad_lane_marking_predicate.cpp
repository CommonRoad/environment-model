...
std::vector<std::shared_ptr<Lanelet>> LeftOfBroadLaneMarkingPredicate::laneletsRightOfVehicle(size_t timeStep, const std::shared_ptr<World> &world,
...
std::vector<std::shared_ptr<Lanelet>> LeftOfBroadLaneMarkingPredicate::laneletsRightOfLanet(const std::shared_ptr<World> &world,
