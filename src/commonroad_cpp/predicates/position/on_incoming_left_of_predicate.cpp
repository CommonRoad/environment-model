...
bool OnIncomingLeftOfPredicate::booleanEvaluation(size_t timeStep, const std::shared_ptr<World> &world,
    ...
    if (!onLaneletWithTypePredicate.booleanEvaluation(timeStep, world, obstacleK, {}, {"incoming"}) or
        !onLaneletWithTypePredicate.booleanEvaluation(timeStep, world, obstacleP, {}, {"incoming"}))
        return false;
