...
std::map<std::string, PredicateParam> paramMap = {
    ...
    {"dCauseBreakingIntersection",
     PredicateParam("dCauseBreakingIntersection",
    ...
    {"stopLineDistance",
     PredicateParam("stopLineDistance", "maximum distance vehicle waiting in front of stop line has to wait [m]", 10.0,
                    0.0, {"stop_line_in_front"}, "distance", "greater", "float", "m", 1.0)},
