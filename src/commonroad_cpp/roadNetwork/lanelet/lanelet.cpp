...
const std::unordered_map<std::string, LaneletType> LaneletTypeNames = {
    ...
    {"BUS_STOP", LaneletType::busStop},
    {"COUNTRY", LaneletType::country},
    {"HIGHWAY", LaneletType::highway},
    {"DRIVEWAY", LaneletType::driveWay},
    {"MAIN_CARRIAGEWAY", LaneletType::mainCarriageWay},
    {"ACCESS_RAMP", LaneletType::accessRamp},
    {"EXIT_RAMP", LaneletType::exitRamp},
    {"SHOULDER", LaneletType::shoulder},
    {"BUS_LANE", LaneletType::busLane},
    {"BIKE_LANE", LaneletType::bikeLane},
