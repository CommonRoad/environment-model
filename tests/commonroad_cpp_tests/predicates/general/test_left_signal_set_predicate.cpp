#include "test_left_signal_set_predicate.h"
#include "../utils_predicate_test.h"

void LeftSignalSetPredicateTest::SetUp() {
...
TEST_F(LeftSignalSetPredicateTest, AlwaysOff) {
...
TEST_F(LeftSignalSetPredicateTest, AlwaysOn) {
    std::shared_ptr<SignalState> signalStateZero =
...
TEST_F(LeftSignalSetPredicateTest, FirstOffThanOn) {
    std::shared_ptr<SignalState> signalStateZero =
        std::make_shared<SignalState>(0, false, false, false, false, false, false);
    std::shared_ptr<SignalState> signalStateOne =
        std::make_shared<SignalState>(1, false, false, false, false, false, false);
...
TEST_F(LeftSignalSetPredicateTest, FirstOnThanOff) {
    std::shared_ptr<SignalState> signalStateZero =
        std::make_shared<SignalState>(2, false, false, false, false, false, false);
    std::shared_ptr<SignalState> signalStateOne =
        std::make_shared<SignalState>(1, false, false, false, false, false, false);
...
TEST_F(LeftSignalSetPredicateTest, Alternating) {
    std::shared_ptr<SignalState> signalStateZero =
        std::make_shared<SignalState>(2, false, true, false, false, false, false);
    std::shared_ptr<SignalState> signalStateOne =
        std::make_shared<SignalState>(1, false, false, false, false, false, false);
...
TEST_F(LeftSignalSetPredicateTest, SignalSeriesNotSet) {
...
TEST_F(LeftSignalSetPredicateTest, RobustEvaluation) {
    EXPECT_THROW(pred.robustEvaluation(0, world, egoVehicle), std::runtime_error);
}

TEST_F(LeftSignalSetPredicateTest, ConstraintEvaluation) {
