#include "test_at_four_way_stop_predicate.h"
#include "commonroad_cpp/interfaces/commonroad/input_utils.h"
#include "commonroad_cpp/obstacle/state.h"

void AtFourWayStopPredicateTest::SetUp() {
...
TEST_F(AtFourWayStopPredicateTest, BooleanEvaluation) {
...
TEST_F(AtFourWayStopPredicateTest, RobustEvaluation) {
    EXPECT_THROW(pred.robustEvaluation(0, world, egoVehicle), std::runtime_error);
}

TEST_F(AtFourWayStopPredicateTest, ConstraintEvaluation) {
