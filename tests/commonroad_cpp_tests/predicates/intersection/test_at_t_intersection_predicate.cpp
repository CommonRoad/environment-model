#include "test_at_t_intersection_predicate.h"
#include "commonroad_cpp/interfaces/commonroad/input_utils.h"
#include "commonroad_cpp/obstacle/state.h"

void AtTIntersectionPredicateTest::SetUp() {
...
TEST_F(AtTIntersectionPredicateTest, BooleanEvaluation) {
...
TEST_F(AtTIntersectionPredicateTest, RobustEvaluation) {
    EXPECT_THROW(pred.robustEvaluation(0, world, obstacleOne, obstacleTwo), std::runtime_error);
}

TEST_F(AtTIntersectionPredicateTest, ConstraintEvaluation) {
