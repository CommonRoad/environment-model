#include "test_at_uncontrolled_intersection_predicate.h"
#include "commonroad_cpp/interfaces/commonroad/input_utils.h"
#include "commonroad_cpp/obstacle/state.h"

void AtUncontrolledIntersectionPredicateTest::SetUp() {
...
TEST_F(AtUncontrolledIntersectionPredicateTest, BooleanEvaluation) {
...
TEST_F(AtUncontrolledIntersectionPredicateTest, RobustEvaluation) {
    EXPECT_THROW(pred.robustEvaluation(0, world, obstacleOne, obstacleTwo), std::runtime_error);
}

TEST_F(AtUncontrolledIntersectionPredicateTest, ConstraintEvaluation) {
