...
#include "commonroad_cpp/predicates/lane/in_neighboring_left_lane_predicate.h"
#include "commonroad_cpp/roadNetwork/road_network.h"
#include "commonroad_cpp/world.h"
#include <gtest/gtest.h>

class TestInNeighboringLeftLanePredicate : public testing::Test {
  protected:
    ...
    InNeighboringLeftLanePredicate pred;
