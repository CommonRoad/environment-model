...
// Credits: BMW Car@TUM
//
#include "test_in_rightmost_lane_predicate.h"
#include "../utils_predicate_test.h"
#include "commonroad_cpp/obstacle/state.h"

void InLRightmostLanePredicateTest::SetUp() {
...
TEST_F(InLRightmostLanePredicateTest, RobustEvaluation) {
    EXPECT_THROW(pred.robustEvaluation(0, world, egoVehicle), std::runtime_error);
}

TEST_F(InLRightmostLanePredicateTest, ConstraintEvaluation) {
