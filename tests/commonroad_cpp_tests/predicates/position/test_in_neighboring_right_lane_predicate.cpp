#include "test_in_neighboring_right_lane_predicate.h"
...
void TestInNeighboringRightLanePredicate::SetUp() {
    std::string pathToTestFile = TestUtils::getTestScenarioDirectory() + "/predicates/DEU_ThreeLanes-1/DEU_ThreeLanes-1_1_T-1.pb";
...
TEST_F(TestInNeighboringRightLanePredicate, BooleanEvaluationObjectsOncoming) {
    ...
    EXPECT_FALSE(pred.booleanEvaluation(0, worldOncoming, obstacleSix, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(1, worldOncoming, obstacleSix, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(2, worldOncoming, obstacleSix, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(3, worldOncoming, obstacleSix, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(4, worldOncoming, obstacleSix, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(5, worldOncoming, obstacleSix, obstacleFive));

    EXPECT_FALSE(pred.booleanEvaluation(0, worldOncoming, obstacleFive, obstacleSix));
    EXPECT_FALSE(pred.booleanEvaluation(1, worldOncoming, obstacleFive, obstacleSix));
    EXPECT_FALSE(pred.booleanEvaluation(2, worldOncoming, obstacleFive, obstacleSix));
    EXPECT_FALSE(pred.booleanEvaluation(3, worldOncoming, obstacleFive, obstacleSix));
    EXPECT_FALSE(pred.booleanEvaluation(4, worldOncoming, obstacleFive, obstacleSix));
    EXPECT_FALSE(pred.booleanEvaluation(5, worldOncoming, obstacleFive, obstacleSix));
}

TEST_F(TestInNeighboringRightLanePredicate, BooleanEvaluationObjectsMultilane) {
    ...
    EXPECT_FALSE(pred.booleanEvaluation(0, world, obstacleEgo, obstacleTwo));
    ...
    EXPECT_FALSE(pred.booleanEvaluation(2, world, obstacleEgo, obstacleThree));
    EXPECT_FALSE(pred.booleanEvaluation(3, world, obstacleEgo, obstacleThree));
    EXPECT_FALSE(pred.booleanEvaluation(4, world, obstacleEgo, obstacleThree));
    EXPECT_FALSE(pred.booleanEvaluation(5, world, obstacleEgo, obstacleThree));

    EXPECT_FALSE(pred.booleanEvaluation(0, world, obstacleEgo, obstacleTwo));
    EXPECT_FALSE(pred.booleanEvaluation(1, world, obstacleEgo, obstacleTwo));
    EXPECT_FALSE(pred.booleanEvaluation(2, world, obstacleEgo, obstacleTwo));
    EXPECT_FALSE(pred.booleanEvaluation(3, world, obstacleEgo, obstacleTwo));
    EXPECT_FALSE(pred.booleanEvaluation(4, world, obstacleEgo, obstacleTwo));
    EXPECT_FALSE(pred.booleanEvaluation(5, world, obstacleEgo, obstacleTwo));

    EXPECT_FALSE(pred.booleanEvaluation(0, world, obstacleTwo, obstacleThree));
    EXPECT_FALSE(pred.booleanEvaluation(1, world, obstacleTwo, obstacleThree));
    ...
    EXPECT_FALSE(pred.booleanEvaluation(2, world, obstacleTwo, obstacleFour));
...
TEST_F(TestInNeighboringRightLanePredicate, RobustEvaluation) {
    EXPECT_THROW(pred.robustEvaluation(0, world, obstacleOne, obstacleTwo), std::runtime_error);
}

TEST_F(TestInNeighboringRightLanePredicate, ConstraintEvaluation) {
