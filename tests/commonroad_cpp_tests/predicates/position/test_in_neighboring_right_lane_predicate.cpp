...
TEST_F(TestInNeighboringRightLanePredicate, BooleanEvaluationObjectsOncoming) {
    ...
    EXPECT_FALSE(pred.booleanEvaluation(0, worldOncoming, obstacleEgo, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(1, worldOncoming, obstacleEgo, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(2, worldOncoming, obstacleEgo, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(3, worldOncoming, obstacleEgo, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(4, worldOncoming, obstacleEgo, obstacleFive));
    EXPECT_FALSE(pred.booleanEvaluation(5, worldOncoming, obstacleEgo, obstacleFive));

    EXPECT_FALSE(pred.booleanEvaluation(5, worldOncoming, obstacleFive, obstacleOne));
    EXPECT_FALSE(pred.booleanEvaluation(5, worldOncoming, obstacleFive, obstacleEgo));
}
