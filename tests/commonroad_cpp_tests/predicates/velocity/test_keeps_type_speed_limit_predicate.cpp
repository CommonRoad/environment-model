...
void KeepsTypeSpeedLimitPredicateTest::SetUp() {
    ...
    obstacleOne = std::make_shared<Obstacle>(1, ObstacleRole::DYNAMIC, stateZeroObstacleOne, ObstacleType::truck, 30,
                                             10, 3, -10, 0.3, trajectoryPredictionObstacleOne, 10, 2);
