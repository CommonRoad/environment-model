...
void SlowOtherVehiclePredicateTest::SetUp() {
    ...
    obstacleTwo = std::make_shared<Obstacle>(2, ObstacleRole::DYNAMIC, stateOneObstacleTwo, ObstacleType::car, 50, 10,
    ...
    obstacleFour = std::make_shared<Obstacle>(4, ObstacleRole::DYNAMIC, stateTwoObstacleFour, ObstacleType::car, 50, 10,
