...
void IntersectionTestInitialization::setUpIntersection() {
    ...
    std::vector<std::shared_ptr<IncomingGroup>> incomingsIntersection1{incomingOne, incomingTwo, incomingThree};
    ...
    std::vector<std::shared_ptr<IncomingGroup>> incomingsIntersection2{incomingTwo};
    ...
    //intersection2->setCrossings(crossingsIntersection2); TODO test crossings in incomingGroup
    intersection2->setIncomingGroups(incomingsIntersection2);
