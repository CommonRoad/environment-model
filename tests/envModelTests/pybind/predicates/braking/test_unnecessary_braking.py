...
class TestBrakingPredicates(unittest.TestCase):
    ...
    def test_keeps_safe_distance(self):
        ...
        exp_sol_constraint_mode_1 = 1 + a_abrupt
        exp_sol_constraint_mode_2 = -1 + a_abrupt
        exp_sol_constraint_mode_3 = -2 + a_abrupt
        exp_sol_constraint_mode_4 = -1.5 + a_abrupt
        exp_sol_constraint_mode_5 = a_abrupt
        exp_sol_constraint_mode_6 = a_abrupt
        ...
        # sol_monitor_mode_2 = cpp_env_model.unnecessary_braking_boolean_evaluation(123, 0, 1, [2, 3])
        # sol_monitor_mode_3 = cpp_env_model.unnecessary_braking_boolean_evaluation(123, 0, 1, [2, 3])
        # sol_monitor_mode_4 = cpp_env_model.unnecessary_braking_boolean_evaluation(123, 0, 1, [2, 3])
        # sol_monitor_mode_5 = cpp_env_model.unnecessary_braking_boolean_evaluation(123, 0, 1, [2, 3])
        # sol_monitor_mode_6 = cpp_env_model.unnecessary_braking_boolean_evaluation(123, 0, 1, [2, 3])
