...
TEST_F(TrafficSignInterpreterTest, SpeedLimit2018b) {
    ...
    std::shared_ptr<Lanelet> lanelet34782 = *std::find_if(lanelets2018b.begin(), lanelets2018b.end(), [](auto &lptr){return lptr->getId() == 34782;});
    std::shared_ptr<Lanelet> lanelet34784 = *std::find_if(lanelets2018b.begin(), lanelets2018b.end(), [](auto &lptr){return lptr->getId() == 34784;});
...
TEST_F(TrafficSignInterpreterTest, SpeedLimit2020a) {
    ...
    std::shared_ptr<Lanelet> lanelet3419 = *std::find_if(lanelets2020a.begin(), lanelets2020a.end(), [](auto &lptr){return lptr->getId() == 3419;});
    std::shared_ptr<Lanelet> lanelet3489 = *std::find_if(lanelets2020a.begin(), lanelets2020a.end(), [](auto &lptr){return lptr->getId() == 3489;});
