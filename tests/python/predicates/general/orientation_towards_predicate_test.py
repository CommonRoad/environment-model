...
class TestOrientationTowardsPredicate(unittest.TestCase):
    ...
    def test_orientation_towards(self):
        ...
        exp_sol_monitor_mode_4 = True  # ego vehicle drives to other from right
        exp_sol_monitor_mode_5 = True  # ego vehicle drives to other from right
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = cpp_env_model.orientation_towards_boolean_evaluation(123, 0, 1, 2)
        sol_monitor_mode_2 = cpp_env_model.orientation_towards_boolean_evaluation(123, 1, 1, 2)
        sol_monitor_mode_3 = cpp_env_model.orientation_towards_boolean_evaluation(123, 2, 1, 2)
        sol_monitor_mode_4 = cpp_env_model.orientation_towards_boolean_evaluation(123, 3, 1, 2)
        sol_monitor_mode_5 = cpp_env_model.orientation_towards_boolean_evaluation(123, 1, 1, 3)
