...
class TestAtRedRightTrafficLightPredicates(unittest.TestCase):
    ...
    def test_at_red_right_traffic_light(self):
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = cpp_env_model.at_red_right_traffic_light_boolean_evaluation(123, 0, 1)
        sol_monitor_mode_2 = cpp_env_model.at_red_right_traffic_light_boolean_evaluation(123, 1, 1)
        sol_monitor_mode_3 = cpp_env_model.at_red_right_traffic_light_boolean_evaluation(123, 2, 1)
        sol_monitor_mode_4 = cpp_env_model.at_red_right_traffic_light_boolean_evaluation(123, 3, 1)
        sol_monitor_mode_5 = cpp_env_model.at_red_right_traffic_light_boolean_evaluation(123, 0, 2)
        sol_monitor_mode_6 = cpp_env_model.at_red_right_traffic_light_boolean_evaluation(123, 1, 2)
