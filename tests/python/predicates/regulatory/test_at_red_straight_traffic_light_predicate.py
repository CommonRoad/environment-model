...
class TestAtRedStraightTrafficLightPredicates(unittest.TestCase):
    ...
    def test_at_red_straight_traffic_light(self):
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = crcpp.at_red_straight_traffic_light_boolean_evaluation(123, 0, 1)
        sol_monitor_mode_2 = crcpp.at_red_straight_traffic_light_boolean_evaluation(123, 1, 1)
        sol_monitor_mode_3 = crcpp.at_red_straight_traffic_light_boolean_evaluation(123, 2, 1)
        sol_monitor_mode_4 = crcpp.at_red_straight_traffic_light_boolean_evaluation(123, 3, 1)
        sol_monitor_mode_5 = crcpp.at_red_straight_traffic_light_boolean_evaluation(123, 0, 2)
        sol_monitor_mode_6 = crcpp.at_red_straight_traffic_light_boolean_evaluation(123, 1, 2)
